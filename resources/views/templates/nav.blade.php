        ...
        <div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample08">
            ...
            <ul class="navbar-nav w-100 mx-auto">
                <li class="nav-item flex-fill mx-2">
                    <a class="navbar-brand" href="#">
                        <img style="width:101px;height:auto" src="{{ asset('storage/logo.png') }}" class="img-responsive">
                    </a>
                </li>
            ...
            <ul class="navbar-nav flex-column">
                ...
                @else
                    ...
                    <li class="nav-item">
                        <form action="{{ route('logout') }}" method="POST"  class="boton-header">
                            @csrf
                            <button type="submit" class="btn btn-link nav-link small boton-header">Cerrar sesión</button>
                        </form>
                    </li>
                @endguest
            </ul>
